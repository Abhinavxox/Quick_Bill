...
public class cashier_login_form extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					cashier_login_form frame = new cashier_login_form();
	...
	private JLabel getLblNewLabel_1() {
		if (lblNewLabel_1 == null) {
			...
			lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\abhin\\Desktop\\java\\workspace\\Quick_Bill\\Icons\\cashier (2).png"));
		...
		if (btnNewButton_1 == null) {
			...
			btnNewButton_1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					for(cashier c:slist) {
						if(user_log.getText().equals(c.getName()) && pass_log.getText().equals(c.getPassword())) {
							is_exist = true;
